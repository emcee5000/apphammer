...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Contact form submission from AppHammer Website";
  ...
  if(!preg_match($email_exp,$email)) {
    $error_message .= 'Looks like something is wrong with the email addres you provided.<br />';
  }
    $string_exp = "/^[A-Za-z .'-]+$/";
  if(!preg_match($string_exp,$firstname)) {
    $error_message .= 'We are informal around here, your first name is important to us!<br />';
  }
    $string_exp = "/^[A-Za-z .'-]+$/";
